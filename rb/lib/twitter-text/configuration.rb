...
module Twitter
  module TwitterText
    class Configuration
      ...
      attr_reader :default_weight, :transformed_url_length, :remove_url_scheme, :extract_urls_without_protocol, :ranges
      ...
      def initialize(config = {})
        ...
        @extract_urls_without_protocol = config[:extractUrlsWithoutProtocol]
